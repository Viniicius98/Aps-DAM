...
import { Text, View,Button, FlatList, ImageProps, Image, SafeAreaView } from 'react-native';
    ...
    return <Item item={item} onPress={() => setSelectedId(Number(item.id))} />;
      ...
      return (
        <SafeAreaView style={homeStyle.homeContainer}>
          <Image style={homeStyle.background} source={require('../../assets/images/background.jpg')} />
